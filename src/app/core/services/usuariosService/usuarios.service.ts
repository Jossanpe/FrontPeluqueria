...
*/
  ...
  obtenerClientes() {
    return this.http.get<Usuario[]>(`${this.base}/usuarios/clientes`);
  }

  obtenerPerfil() {
    return this.http.get<Usuario>(`${this.base}/usuarios/perfil`);
  }

  actualizarPerfil(usuario: Usuario) {
    return this.http.put<Usuario>(`${this.base}/usuarios/update`, usuario);
  }
}
